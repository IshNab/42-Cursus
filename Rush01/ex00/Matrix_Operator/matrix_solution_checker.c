...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   matrix_solution_checker.c                          :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: dinepomu <dinepomu@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/10/13 11:09:13 by ahugi             #+#    #+#             */
/*   Updated: 2024/10/13 17:35:38 by dinepomu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	matrix_solution_checker(int **matrix_solution, int **matrix_flags)
{
	...
	if (matrix_solution[0][0] < matrix_flags[0][0])
		i++;
	else if (matrix_solution[1][0] < matrix_flags[0][0] && matrix_solution[1][0] < matrix_solution[0][0])
		i++;
	else if (matrix_solution[2][0] < matrix_flags[0][0] && matrix_solution[2][0] < matrix_solution[1][0] && matrix_solution[2][0] < matrix_solution[0][0])
		i++;
	else if (matrix_solution[3][0] < matrix_flags[0][0] && matrix_solution[3][0] < matrix_solution[2][0] && matrix_solution[3][0] < matrix_solution[1][0] && matrix_solution[3][0] < matrix_solution[0][0])
		i++;
